          ...
          <div className="row gy-4 gx-5 align-items-center">
            <div className="col-lg-12">
              ...
              <ul className="crumb wow fadeInUp" style={{ 
                ...
                <li className="active" style={{ color: '#ffffff' }}>Solar Energy Services</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row align-items-center mb-5">
            <div className="col-lg-12 text-center">
              ...
              <p className="lead">End-to-end solar solutions for homes and businesses in Jaipur and across Rajasthan</p>
            </div>
          </div>

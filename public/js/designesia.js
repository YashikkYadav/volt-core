...
(function($) {
    ...
    // Expose key functions globally for reinitialization
    window.menu_arrow = menu_arrow;
    window.custom_elements = custom_elements;
    window.custom_bg = custom_bg;
    window.video_autosize = video_autosize;
    window.load_owl = load_owl;
    window.load_magnificPopup = load_magnificPopup;
    window.init = init;
    window.init_resize = init_resize;
    window.de_progress = de_progress;
    window.centerY = centerY;
    window.grid_gallery = grid_gallery;
    window.filter_gallery = filter_gallery;
    window.masonry = masonry;
    window.header_sticky = header_sticky;
    window.de_counter = de_counter;
